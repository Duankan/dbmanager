...
export default {
  ...
  methods: {
    ...
    getParams() {
      ...
      for (var i = 0; i < 10; i++) {
        aa +=
          '{"name":"rule3","cqlFilter":"\\" \\"=\'8.30523447197E7\'","polygonSymbolizers":[{"fill":{"strColor":"#37d4fb","numOpacity":1},"offset":{"offsetX":0,"offsetY":0}}]}';
      }*/
      ...
      let sdl =
        '{"nameLayers":[{"name":"","style":[{"name":"Style1lxc208","featureTypeStyle":[{"rule":[{"polygonSymbolizers":[{"stroke":null,"fill":{"graphicFill":null,"numOpacity":1,"strColor":"#87b7d6"},"offset":{"offsetX":"0.0","offsetY":"0.0"}}],"textSymbolizers":null,"name":"rule1","cqlFilter":"\\"面积\\"=\'1.7927942E8\'","minScaleDenominator":"","maxScaleDenominator":""},' +
        sdlfen +
...
<template>
  <div>
    ...
    <p>
      ...
      <Button @click="getColor">分类</Button>
